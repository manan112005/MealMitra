    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl max-w-lg w-full overflow-hidden shadow-2xl border border-[#dcc1b1]/60 my-8">
        ...
        <div className="px-6 py-4 border-b border-[#eeeeed] flex justify-between items-center bg-[#faf9f8]">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-full text-[#564337] hover:bg-[#eeeeed] transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handlePlaceReservation} className="p-6 space-y-5">
            {/* Meal summary banner */}
            ...
            {isSoldOut ? (
                ...
                {waitlistJoined ? (
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      ...
                      className="w-full py-2.5 bg-[#51634c] hover:bg-[#3f4e3b] text-white font-bold text-xs rounded-xl shadow-xs transition-colors flex items-center justify-center gap-2"
                    >
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 py-2 bg-white border border-[#dcc1b1] text-[#564337] font-bold text-xs rounded-xl hover:bg-[#eeeeed]"
                      >
                        Book for Tomorrow
                      </button>
                      <button
                        ...
                        className="flex-1 py-2 bg-white border border-[#dcc1b1] text-[#944a00] font-bold text-xs rounded-xl hover:bg-[#eeeeed]"
                      >
                        View Similar Chefs
                      </button>
                    </div>
              ...
              <>
                ...
                >
                  {isProcessingPayment 
                    ? 'Processing Payment...' 
                    : `Pay Securely & Reserve Slot • ₹${total}`}
                </button>
              </>
            )}
          </form>
